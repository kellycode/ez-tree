...
export class Ground extends THREE.Mesh {
    constructor(preloads) {
        ...
        _grassTexture = preloads.textures["./public/grass.jpg"];
        ...
        _dirtTexture = preloads.textures["./public/dirt_color.jpg"];
        ...
        _dirtNormal = preloads.textures["./public/dirt_normal.jpg"];
