...
export function createScene(renderer, preloads) {
    ...
    // SLOWER TREE LOADING WITH UI UPDATED
    function loadTrees(i) {
        if (i < treeCount) {
            ...
            // Request the next frame for the next update
    ...
    // Start the tree loading process with UI update using
    // requestAnimationFrame update so a little slower
    // loadTrees(0);


    // FASTER TREE LOADING WITHOUT UI UPDATED
    function loadTreesFast(i) {
